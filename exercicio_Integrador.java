...
public class exercicio_Integrador {
    public static void main(String args[]) {
        ...
        if(signo == "") { System.out.println("Data inválida!");}
            ...
            //este if verifica se o dia atual é igual ao dia de aniversário do usuário E se o mês atual é igual ao mês de aniversário do usuário
            if(diaAniversario == diaAtual && mesAniversario == mesAtual) {
                //se as datas forem iguais uma menságem de parabéns é exibida
                System.out.println("“Parabéns pelos eu aniversario!");
            }
        }
